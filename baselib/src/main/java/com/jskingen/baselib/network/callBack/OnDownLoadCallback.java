...
public abstract class OnDownLoadCallback implements Callback<ResponseBody>, IFileCallBack {
    ...
    public OnDownLoadCallback(String filePath) {
        this.filePath = filePath;
    }

    public OnDownLoadCallback(String filePath, AlertDialog mDialog) {
        this.filePath = filePath;
        if (mContext == null) {
