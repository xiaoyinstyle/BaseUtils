...
/**
 * Author by ChneYin, Email 976370887@qq.com, Date on  2019/4/30.
 * 添加了 自定义 指示条的长度控制
 */
@ViewPager.DecorView
public class XTabLayout extends HorizontalScrollView {
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabLineOffset = a.getResourceId(R.styleable.TabLayout_tabLineOffset,
                0);//指示器的长度
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                if (mTabLineOffset == 0) {
                    ...
                    canvas.drawRoundRect(oval3,
                            mTabStrip.mSelectedIndicatorHeight / 2, mTabStrip.mSelectedIndicatorHeight / 2,
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public TabLayoutOnPageChangeListener(XTabLayout XTabLayout) {
            mTabLayoutRef = new WeakReference<>(XTabLayout);
        }
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final XTabLayout XTabLayout = mTabLayoutRef.get();
            if (XTabLayout != null) {
                ...
                XTabLayout.setScrollPosition(position, positionOffset, updateText, updateIndicator);
            }
        }
        ...
        public void onPageSelected(final int position) {
            final XTabLayout XTabLayout = mTabLayoutRef.get();
            if (XTabLayout != null && XTabLayout.getSelectedTabPosition() != position
                    && position < XTabLayout.getTabCount()) {
                // Select the tab, only updating the indicator if we're not being dragged/settled
                // (since onPageScrolled will handle that).
                final boolean updateIndicator = mScrollState == SCROLL_STATE_IDLE
                        || (mScrollState == SCROLL_STATE_SETTLING
                        && mPreviousScrollState == SCROLL_STATE_IDLE);
                XTabLayout.selectTab(XTabLayout.getTabAt(position), updateIndicator);
            }
        }
