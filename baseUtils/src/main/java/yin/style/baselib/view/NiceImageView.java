...
/**
 * Author by ChneYin, Email 976370887@qq.com, Date on  2019/4/22.
...
public class NiceImageView extends AppCompatImageView {
    ...
    public void setBorderWidth(int borderWidth, boolean unitIsPx) {
        if (unitIsPx)
    ...
    public void setInnerBorderWidth(int innerBorderWidth, boolean unitIsPx) {
        if (unitIsPx)
    ...
    public void setCornerRadius(int cornerRadius, boolean unitIsPx) {
        if (unitIsPx)
    ...
    public void setCornerTopLeftRadius(int cornerTopLeftRadius, boolean unitIsPx) {
        if (unitIsPx)
    ...
    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius, boolean unitIsPx) {
        if (unitIsPx)
    ...
    public void setCornerBottomRightRadius(int cornerBottomRightRadius, boolean unitIsPx) {
        if (unitIsPx)
