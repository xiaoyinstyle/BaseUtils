            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                if (showNotify) {
                    ...
                    if (intent.getIntExtra("icRes", 0) != 0) {
                        ...
                        builder.setSmallIcon(R.drawable.ic_update_launcher); //设置图标
                    }
                    RemoteViews contentView = new RemoteViews(mContext.getPackageName(), R.layout.base_notification_upload);
