...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private RelativeLayout headerContext;
    ...
    private void initView() {
        ...
        headerContext = (RelativeLayout) findViewById(R.id.listview_header_content);
    ...
    public void setHeight(int height) {
        ...
        LinearLayout.LayoutParams lp2 = (LinearLayout.LayoutParams) headerContext.getLayoutParams();
        lp2.height = height;
        headerContext.setLayoutParams(lp2);
